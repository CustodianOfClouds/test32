...
echo "========================================="
java LZWTool --mode compress --minW 3 --maxW 4 --policy lru --alphabet test_alphabet.txt < test_input.txt > test_compressed.lzw 2> compress_debug.log
if [ $? -ne 0 ]; then
